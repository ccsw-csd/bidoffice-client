...
describe('FileTypeEditComponent', () => {
    ...
    let FILETYPE_ITEM_EDITED: FileType[];
    let FILETYPE_ITEM_SAVED: FileType[];
    ...
    beforeEach(() => {
      ...
      FILETYPE_ITEM_EDITED = [
        new FileType ({id:1,name:"test",priority:2}),
        new FileType({id:2,name:"test2",priority:3}),
        new FileType({id:3,name:"New test",priority:1}),
      ]
      FILETYPE_ITEM_SAVED = [
        new FileType ({id:1,name:"test",priority:2}),
        new FileType({id:2,name:"test2",priority:3}),
        new FileType({id:3,name:"tes3t",priority:1}),
        new FileType({id:3,name:"New saved test",priority:1}),
      ]
